...
- Follow Pythonic philosophy where it improves readability: explicit is better than implicit, simple is better than complex, and flat is better than nested.
- Avoid five-level indentation or deeper. Prefer guard clauses, early returns, and small named helpers to keep control flow flat.
