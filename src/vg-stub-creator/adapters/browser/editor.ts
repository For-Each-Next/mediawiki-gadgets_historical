 ...
 *   generated wikitext.
 */
export function writeEditText(
    text: string,
    unavailableMessage: string = "MediaWiki edit textbox is unavailable.",
): void {
...
export function submitPreviewForm(
    unavailableMessage: string = "MediaWiki preview form is unavailable.",
): void {
