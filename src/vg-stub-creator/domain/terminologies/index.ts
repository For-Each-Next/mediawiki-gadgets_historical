import companies from "#gadget/domain/terminologies/companies.ts";
import genres from "#gadget/domain/terminologies/genres.ts";
import platforms from "#gadget/domain/terminologies/platforms.ts";
import years from "#gadget/domain/terminologies/years.ts";
