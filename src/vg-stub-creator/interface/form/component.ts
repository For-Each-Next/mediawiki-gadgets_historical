...
import { splitFieldValues } from "../../shared/utils.ts";
import {
    createSaveProgress,
    getSaveProgressGroups,
    isSaveProgressComplete,
    updateSaveProgress,
} from "../../save/progress.ts";
import { sortNoteTaEntries } from "../../wikitext/note-ta.ts";
import {
    createPreSaveGroups,
...
function getPreviewSetupState(): any {
     ...
     *
     */
    function getPageEditCreateState(
        row: any,
