/**
 * Defines field reference data.
 *
 * Provides shared formatting and reference lookup helpers for the
 * gadget.
 */

import fieldData from "../field-data.ts";

export const FIELD_REFERENCE_DATA = fieldData;
