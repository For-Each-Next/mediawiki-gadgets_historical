...
export function createDialogComponent(Vue, options) {
    ...
    const methods = {
        ...
        getPreSaveStatusIconClass(status) {
            ...
            return `vg-stub-creator-pre-save-status-icon vg-stub-creator-pre-save-status-icon--${normalized}`;
        },
        ...
        getPreSaveProgressRowClass(step) {
            ...
            return active
                ? `vg-stub-creator-pre-save-progress-row vg-stub-creator-pre-save-progress-row--${status}`
                : "vg-stub-creator-pre-save-progress-row";
        },
