...
function getCitationRules() {
    if (typeof __VG_STUB_CREATOR_FIELD_DATA__ === "undefined") {
        return [];
    }

    return __VG_STUB_CREATOR_FIELD_DATA__["citation-rules"] || [];
}
...
function getCitationTemplateData() {
    ...
    return __VG_STUB_CREATOR_FIELD_DATA__["citation-template"] || {};
}
