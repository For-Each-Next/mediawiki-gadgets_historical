...
} from "../../src/vg-page-assessor/assessment.ts";
 ...
 *
 * @param className - Assessment class.
 * @param banners - Nested banner calls.
 * @returns Expected shell text.
 */
function expectedShell(className: string, banners: Array<string>): string {
    return [
