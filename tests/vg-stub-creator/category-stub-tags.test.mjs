...
globalThis.__VG_STUB_CREATOR_FIELD_DATA__ = {
    ...
    wikitext: globalThis.__VG_STUB_CREATOR_FIELD_DATA__.wikitext,
};

const { buildCategoryRows } = await import("../../src/vg-stub-creator/src/handlers/categories.js");
const { createArticleData } = await import("../../src/vg-stub-creator/src/article/index.js");
