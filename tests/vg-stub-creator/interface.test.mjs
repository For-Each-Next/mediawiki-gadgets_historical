...
import {
    ...
    createPreSaveGroups,
} from "../../src/vg-stub-creator/src/interface/form/index.js";
...
afterEach(() => {
    ...
    delete globalThis.__VG_STUB_CREATOR_FIELD_DATA__;
});
...
test("References tab manages editable citation parameters", async () => {
    globalThis.__VG_STUB_CREATOR_FIELD_DATA__ = {
        "citation-template": {
            aliases: {
...
test("category helper stages missing category rows for final submission", async () => {
    ...
    assert.equal(
        component.template.indexOf("English Wikipedia category") <
            component.template.indexOf("vg-stub-creator-company-category-text"),
        true,
    );
